...
const styles = StyleSheet.create({
  ...
  chip: { borderWidth: 1, borderColor: theme.border, borderRadius: 20, paddingHorizontal: 14, paddingVertical: 6, backgroundColor: theme.surfaceAlt },
  ...
  check: { fontSize: 22, color: theme.textMuted },
  checkOn: { color: theme.ok },
  goalText: { flex: 1, fontSize: 15, color: theme.text },
  goalDone: { color: theme.textFaint, textDecorationLine: 'line-through' },
  remove: { fontSize: 16, color: theme.danger, fontWeight: '700', paddingHorizontal: 4 },
});
