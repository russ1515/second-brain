...
const PRIORITY_COLOR: Record<RevisionPriority, string> = {
  urgent: theme.danger,
  high: theme.warn,
  medium: theme.accent,
  low: theme.ok,
...
function ConceptRow({
  ...
  return (
    <View style={styles.card}>
      ...
      <View style={[styles.priority, { borderColor: PRIORITY_COLOR[c.revisionPriority] }]}>
        <Text style={[styles.priorityText, { color: PRIORITY_COLOR[c.revisionPriority] }]}>
...
const styles = StyleSheet.create({
  ...
  stars: { fontSize: 17, color: theme.warn, letterSpacing: 1 },
  ...
  signalValue: { fontSize: 15, fontWeight: '600', color: theme.text },
  priority: {
