...
export type ModeKey = 'free' | 'teach' | 'explain' | 'discuss' | 'oralex' | 'oralexam' | 'guided' | 'deepsearch';
...
export const MODES: TeachingMode[] = [
  // Recherche Libre IA (§10): a free question — academic, technical or general —
  // without needing to pick a document. A conversation MODE, never a 6th space.
  { key: 'free', icon: '🔎', label: 'Question libre', desc: 'Pose une question — académique, technique ou générale — sans document.', route: '/tutor', mode: 'free' },
