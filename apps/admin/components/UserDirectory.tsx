...
function themeFor(dark: boolean): Theme {
  return dark
    ...
    : { surface: '#fff', mutedSurface: '#f8fafc', border: '#dbe4ee', text: '#0f172a', muted: '#475569', primary: '#1d4ed8', primarySoft: '#dbeafe', danger: '#b91c1c', warning: '#92400e', success: '#065f46' };
}
